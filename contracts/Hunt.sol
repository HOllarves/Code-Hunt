...
contract Hunt is Ownable {
    ...
    */
    function createBounty(string repo, uint issue, uint256 duration) public payable {
        assert(msg.value > 0);
        assert(duration > 0);
    ...
    */
    function submitHunt(address bountyAddr, uint prID) public {
    ...
    @param bountyAddr Bounty address
    */
    function acceptHunt(address subAddr, address bountyAddr) public {
    ...
    */
    function getBounty(address bountyAddr) public view returns 
        ...
        return 
        (avBounties[bountyAddr].repoUrl, avBounties[bountyAddr].issueID, 
        avBounties[bountyAddr].prize, avBounties[bountyAddr].duration, avBounties[bountyAddr].createdOn,
        avBounties[bountyAddr].finished, avBounties[bountyAddr].fixedBy);
    }
